...
- Keep the v2 flat palette (`black=43`, `gray=154`, `white=201`) matched to the four-source production-resolution means of its material ranges (`20-58`, `103-186`, `132-244`), and retain `crispEdges` material rendering to suppress patch-seam moiré; changing either requires remeasurement and full v2 regeneration.
